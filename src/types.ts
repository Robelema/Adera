...
export const translations = {
  en: {
    ...
    trial_expired_msg: 'Your trial has expired. Please upgrade to continue using all features.',
  },
  am: {
    dashboard: 'ዳሽቦርድ',
    inventory: 'ዕቃዎች ዝርዝር',
    ...
    past_due: 'ክፍያ ያለፈበት',
    cancelled: 'ተሰርዟል',
    shops_limit: 'የሱቆች ብዛት',
    users_limit: 'የተጠቃሚዎች ብዛት',
    unlimited: 'ያልተገደበ',
    audit_logs: 'የኦዲት መዝገቦች',
    api_access: 'የኤፒአይ መዳረሻ',
    multi_branch: 'የብዙ ቅርንጫፎች ሪፖርት',
    advanced_analytics: 'ጥልቅ ትንተና',
    upgrade_required: 'ማሻሻል ያስፈልጋል',
    trial_expired_msg: 'የሙከራ ጊዜዎ አልቋል። ሁሉንም አገልግሎቶች ለመጠቀም እባክዎ ያሻሽሉ።',
  }
};
